...
<%@taglib uri = "http://java.sun.com/jstl/core_rt" prefix ="c"%>
    ...
    <div class="container">
                    ...
                    <form name ="frmDmk" action="${url}/change-password" method="post">
                            <img src="<c:url  value = "/views/img/lock-solid.png"/>" class="img-fluid offset-4 my-3"/>
                            ...
                            <h5 class="text-center font_2" >
                                ...
                                <div class=" offset-3 col-8" >
                                    ...
                                    <div class="form-floating col-8">
                                        ...
                                        <input type="text" name="oldpass"  class="form-control "  placeholder="Nhập mật khẩu cũ" >
