...
<div class="container-fluid">
    ...
    <div class="row row-cols-auto justify-content-md-center" style="margin-top: 15px;">
        ...
        <div id="box" ng-repeat="p in products | limitTo: 6:begin | filter:searchPhim" class="rol-md-6 rol-12 mt-2 text-center" >
            <div class="card shadow-sm text-center">
                ...
                <div class="card-footer bg-light">
                    <a class="btn btn-outline-dark btn-lg d-block" role="button" href="#!detailFilm" ng-click ="chiTiet()">Xem phim</a>
                </div>
