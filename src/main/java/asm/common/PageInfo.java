...
public static Map<PageType, PageInfo> pageRoute = new HashedMap();
	static {
		...
		pageRoute.put(PageType.SITE_SIGNUP_PAGE, new PageInfo("Registration","/views/main/DangKy.jsp",null));
		...
		pageRoute.put(PageType.SITE_EDIT_PROFILE_PAGE, new PageInfo("Profile","/views/main/hoSoCaNhan.jsp",null));
